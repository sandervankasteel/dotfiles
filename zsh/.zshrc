...
plugins=(git python vagrant)

# User configuration

export PATH="/sw/bin:/sw/sbin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/opt/X11/bin:~/.composer/vendor/bin"
...
export PATH=/usr/local/Cellar/php70/7.0.20_12/bin:$PATH
...
alias homeboy='php ~/tools/homeboy/homeboy'
